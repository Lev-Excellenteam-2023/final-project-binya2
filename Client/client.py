            ...
            if choice == '1':
                ...
                while True:
                        ...
                        if email != '0':
                            ...
                            email = None
                        if ('@' in email or email == None) and os.path.isfile(file_path):
                            break


                uid = upload_file(file_path, base_url, email)
                ...
                while True:
                    if choice == '1':
                        ...
                        break
                    choice = input("Enter 1 to check status by UID or 2 to check status by email and filename or 0 to exit: ")
            elif choice == '0':
                break
